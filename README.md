...
- **Package Manager BUN**
- **Ethernet**
# 🧠 Providers: OpenAI API, DeepSeek, Mistral AI, Ollama, HugginFace and other AI models Interaction Program 
...
```
2. 🧸 Before starting, add your token to the **`.env IN usingOpenAI/.env`** file under Environment Variables for the desired neural network.
3. ✨ Run the program:
bun index.ts
## 👥 For Whom?
